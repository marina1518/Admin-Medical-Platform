  ...
  const Profit_hospitals_Api = async () => {
    ...
    try {
      const res = await axios.get(
        `https://future-medical.herokuapp.com/admin/dashboard/profit/${start}/${end}`,
        {
          headers: {
    ...
    <Card className="chart">
      <div>
        ...
        >
          ...
          <Button
            style={{ marginLeft: "27%", marginTop: "15px", width: "40%" }}
            variant="primary"
            type="submit"
          >
            Show
        ...
        {no_profit_flag && (
          <p className="no-profit">No profit in this period</p>
        )}
        {show && (
          <Chart
